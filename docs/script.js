...
(function () {
  ...
  var DIM = {
    ...
    "fame": { tx: { fr: "La médiation d'Olivia Martin fait de ce récital un espace de parole sur la féminité et le harcèlement de rue, ouvert à tou·te·s.", es: "La mediación de Olivia Martin convierte el recital en un espacio de palabra sobre la feminidad y el acoso callejero, abierto a todos.", en: "Olivia Martin's mediation turns the recital into a space for speech about femininity and street harassment, open to all.", zh: "Olivia Martin 的导赏让这场独奏会成为面向所有人、谈论女性气质与街头性骚扰的发声空间。" },
  ...
  var PROJECTS = [
    ...
    },
    {
      ...
      short: { fr: "Récital de percussions d'Olivia Martin, autour de la féminité.", es: "Recital de percusión de Olivia Martin, en torno a la feminidad.", en: "A percussion recital by Olivia Martin, around femininity.", zh: "Olivia Martin 的打击乐独奏会，围绕女性主题。" },
      pitch: {
        fr: "<em>Pop-Up Exploratoire #1</em> conçu avec le GRAME : un récital où la percussionniste Olivia Martin construit, à travers la création contemporaine, un parcours autour de la féminité et de la place faite aux femmes. Porté par la médiation de Guillaume Kosmicki, ce programme « pour tou·te·s » devient un espace de parole — on y entend notamment une œuvre phare de <strong>Jacques Rebotier sur le harcèlement de rue</strong>. Créé à l'Auditorium — Orchestre National de Lyon (Salle Proton).",
        es: "<em>Pop-Up Exploratoire #1</em> ideado con el GRAME: un recital en el que la percusionista Olivia Martin traza, a través de la creación contemporánea, un recorrido en torno a la feminidad y al lugar de las mujeres. Con la mediación de Guillaume Kosmicki, este programa «para todos» se vuelve un espacio de palabra — se escucha en particular una obra emblemática de <strong>Jacques Rebotier sobre el acoso callejero</strong>. Estrenado en el Auditorium — Orchestre National de Lyon (Salle Proton).",
        en: "<em>Pop-Up Exploratoire #1</em>, devised with GRAME: a recital in which percussionist Olivia Martin traces, through contemporary creation, a path around femininity and the place given to women. Hosted by Guillaume Kosmicki, this “for everyone” programme becomes a space for speech — featuring a landmark piece by <strong>Jacques Rebotier on street harassment</strong>. Premiered at the Auditorium — Orchestre National de Lyon (Salle Proton).",
        zh: "<em>Pop-Up Exploratoire #1</em>，与 GRAME 共同构想：打击乐演奏家 Olivia Martin 借由当代创作，编织出一条围绕女性气质与女性处境的线索。在 Guillaume Kosmicki 的导赏下，这场「面向所有人」的节目成为发声的空间——其中包括 <strong>Jacques Rebotier 一部关于街头性骚扰的标志性作品</strong>。于里昂大礼堂——国家管弦乐团（Salle Proton）首演。" },
      facts: [
        ...
        { k: { fr: "Thème", es: "Tema", en: "Theme", zh: "主题" }, v: { fr: "Féminité · place des femmes", es: "Feminidad · lugar de las mujeres", en: "Femininity · women's place", zh: "女性气质 · 女性处境" } },
        { k: { fr: "Interprète", es: "Intérprete", en: "Performer", zh: "演奏" }, v: "Olivia Martin" },
        { k: { fr: "Œuvre phare", es: "Obra destacada", en: "Flagship work", zh: "焦点作品" }, v: { fr: "J. Rebotier — sur le harcèlement de rue", es: "J. Rebotier — sobre el acoso callejero", en: "J. Rebotier — on street harassment", zh: "J. Rebotier —— 关于街头性骚扰" } },
