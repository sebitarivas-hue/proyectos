...
(function () {
  ...
  var UI = {
    sheet:    { fr: "Voir la fiche", es: "Ver la ficha", en: "View sheet", zh: "查看详情", it: "Vedi la scheda" },
    close:    { fr: "Replier", es: "Cerrar", en: "Close", zh: "收起", it: "Chiudi" },
    details:  { fr: "Informations", es: "Información", en: "Details", zh: "信息", it: "Informazioni" },
    credits:  { fr: "Générique", es: "Créditos", en: "Credits", zh: "创作团队", it: "Crediti" },
    partners: { fr: "Production & partenaires", es: "Producción & socios", en: "Production & partners", zh: "制作与合作", it: "Produzione & partner" },
    press:    { fr: "Revue de presse", es: "Reseña de prensa", en: "Press", zh: "媒体评论", it: "Rassegna stampa" },
    links:    { fr: "À voir & écouter", es: "Ver & escuchar", en: "Watch & listen", zh: "观看与聆听", it: "Da vedere & ascoltare" },
    pressPdf: { fr: "Télécharger la revue de presse (PDF)", es: "Descargar la reseña de prensa (PDF)", en: "Download the press review (PDF)", zh: "下载媒体评论（PDF）", it: "Scarica la rassegna stampa (PDF)" }
  };
  ...
  var YEARS = {
    ...
    "war-madrigals": "2026",
    "salamandres": "2027",
    "nous": { fr: "en cours", es: "en curso", en: "ongoing", zh: "进行中", it: "in corso" },
    "rut": "2026",
    "insistir": "2026",
    "fame": "2021",
    "america": { fr: "en création", es: "en creación", en: "in creation", zh: "创作中", it: "in creazione" },
    "mamma-roma": "2027",
    "otages": "2024",
    "lips": { fr: "Biennal · 2028", es: "Bienal · 2028", en: "Biennial · 2028", zh: "双年 · 2028", it: "Biennale · 2028" }
  };

  var ONGOING = { fr: "en cours", es: "en curso", en: "ongoing", zh: "进行中", it: "in corso" };
  ...
  var MODE_META = {
    production: { color: "#0d0d0f", chip: { fr: "Production", es: "Producci\u00f3n", en: "Production", zh: "\u5236\u4f5c", it: "Produzione" }, label: { fr: "Production", es: "Producci\u00f3n", en: "Production", zh: "\u5236\u4f5c", it: "Produzione" }, desc: { fr: "STOPERA! cr\u00e9e et porte l'\u0153uvre.", es: "STOPERA! crea y lleva la obra.", en: "STOPERA! creates and carries the work.", zh: "STOPERA! \u521b\u4f5c\u5e76\u627f\u5236\u4f5c\u54c1\u3002", it: "STOPERA! crea e porta l'opera." } },
    tournee: { color: "#2f8f96", chip: { fr: "Tourn\u00e9e", es: "Gira", en: "Touring", zh: "\u5de1\u6f14", it: "Tournée" }, label: { fr: "Tourn\u00e9e & diffusion", es: "Gira & difusi\u00f3n", en: "Touring & diffusion", zh: "\u5de1\u6f14\u4e0e\u63a8\u5e7f", it: "Tournée & distribuzione" }, desc: { fr: "STOPERA! diffuse \u00e0 l'international une \u0153uvre cr\u00e9\u00e9e ailleurs.", es: "STOPERA! difunde internacionalmente una obra creada en otro lugar.", en: "STOPERA! tours a work created elsewhere.", zh: "STOPERA! \u5728\u56fd\u9645\u4e0a\u63a8\u5e7f\u4ed6\u65b9\u521b\u4f5c\u7684\u4f5c\u54c1\u3002", it: "STOPERA! distribuisce a livello internazionale un'opera creata altrove." } },
    accompagnement: { color: "#6a4fa0", chip: { fr: "Accompagnement", es: "Acompa\u00f1amiento", en: "Support", zh: "\u966a\u4f34", it: "Accompagnamento" }, label: { fr: "Accompagnement", es: "Acompa\u00f1amiento", en: "Support", zh: "\u966a\u4f34", it: "Accompagnamento" }, desc: { fr: "STOPERA! accompagne un projet port\u00e9 par un tiers.", es: "STOPERA! acompa\u00f1a un proyecto de un tercero.", en: "STOPERA! supports a project led by others.", zh: "STOPERA! \u966a\u4f34\u7531\u7b2c\u4e09\u65b9\u4e3b\u5bfc\u7684\u9879\u76ee\u3002", it: "STOPERA! accompagna un progetto portato da altri." } },
    pedagogie: { color: "#d61f7a", chip: { fr: "P\u00e9dagogie", es: "Pedagog\u00eda", en: "Education", zh: "\u6559\u80b2", it: "Pedagogia" }, label: { fr: "P\u00e9dagogie & transmission", es: "Pedagog\u00eda & transmisi\u00f3n", en: "Education & transmission", zh: "\u6559\u80b2\u4e0e\u4f20\u627f", it: "Pedagogia & trasmissione" }, desc: { fr: "Le laboratoire LIPS et la transmission.", es: "El laboratorio LIPS y la transmisi\u00f3n.", en: "The LIPS lab and transmission.", zh: "LIPS \u5b9e\u9a8c\u5ba4\u4e0e\u4f20\u627f\u3002", it: "Il laboratorio LIPS e la trasmissione." } }
  };
  ...
  var DIM = {
    "salamandres": { tx: { fr: "Le projet naît d'un travail avec les populations : une recherche-action en éducation populaire (quartier Briand, Mulhouse, 2021–2026), des centaines d'heures d'ateliers et de répétitions pour former une « communauté esthétique ».", es: "El proyecto nace de un trabajo con las poblaciones: una investigación-acción en educación popular (barrio Briand, Mulhouse, 2021–2026), cientos de horas de talleres y ensayos para formar una « comunidad estética ».", en: "The project grows out of work with communities: an action-research in popular education (Briand neighbourhood, Mulhouse, 2021–2026), hundreds of hours of workshops and rehearsals to form an “aesthetic community.”", zh: "项目源于与民众的工作：一项平民教育的行动研究（米卢斯 Briand 街区，2021–2026），数百小时的工作坊与排练，以形成「审美共同体」。", it: "Il progetto nasce da un lavoro con gli abitanti: una ricerca-azione di educazione popolare (quartiere Briand, Mulhouse, 2021–2026), centinaia di ore di laboratori e di prove per formare una «comunità estetica»." },
      terr: { fr: "Ancrage local fort : matériaux collectés sur place avec les habitant·es et les associations, à chaque lieu d'accueil — écologie du réemploi et localisme.", es: "Fuerte arraigo local: materiales recogidos in situ con los habitantes y las asociaciones, en cada lugar de acogida — ecología de la reutilización y localismo.", en: "Strong local roots: materials gathered on site with residents and associations, at each host venue — an ecology of re-use and localism.", zh: "深厚的在地扎根：材料在每个接待地与居民和社团就地采集——再利用的生态与在地主义。", it: "Forte radicamento locale: materiali raccolti sul posto con gli abitanti e le associazioni, in ogni spazio ospite — ecologia del riuso e localismo." } },
    "ooo": { tx: { fr: "Ateliers sur la lutherie d'objets et la dramaturgie post-humaine — faire chanter la matière et le son.", es: "Talleres sobre la lutería de objetos y la dramaturgia posthumana — hacer cantar la materia y el sonido.", en: "Workshops on object-instruments and post-human dramaturgy — making matter and sound sing.", zh: "围绕物件乐器与后人类戏剧构作的工作坊——让物质与声音歌唱。", it: "Laboratori sulla liuteria di oggetti e la drammaturgia post-umana — far cantare la materia e il suono." },
      terr: { fr: "Un pont entre Buenos Aires et Lyon, porté en tournée internationale.", es: "Un puente entre Buenos Aires y Lyon, llevado en gira internacional.", en: "A bridge between Buenos Aires and Lyon, taken on international tour.", zh: "连接布宜诺斯艾利斯与里昂的桥梁，并展开国际巡演。", it: "Un ponte tra Buenos Aires e Lione, portato in tournée internazionale." } },
    "war-madrigals": { tx: { fr: "Travail vocal en atelier autour du madrigal et de l'écriture pour six voix.", es: "Trabajo vocal en taller en torno al madrigal y la escritura para seis voces.", en: "Vocal workshops around the madrigal and writing for six voices.", zh: "围绕牧歌与六声部写作的人声工作坊。", it: "Lavoro vocale in laboratorio intorno al madrigale e alla scrittura per sei voci." },
      terr: { fr: "Porté par le réseau des ensembles vocaux, en France et au-delà.", es: "Llevado por la red de conjuntos vocales, en Francia y más allá.", en: "Carried by the network of vocal ensembles, in France and beyond.", zh: "依托人声合奏团的网络，在法国及更广地区呈现。", it: "Portato dalla rete degli ensemble vocali, in Francia e oltre." } },
    "nous": { tx: { fr: "Partage de la méthode : composer à partir de la parole vivante, en ateliers d'écriture et de voix.", es: "Compartir el método: componer a partir de la palabra viva, en talleres de escritura y voz.", en: "Sharing the method: composing from living speech, in writing and voice workshops.", zh: "分享创作方法：从鲜活的言语出发作曲，开展写作与人声工作坊。", it: "Condivisione del metodo: comporre a partire dalla parola viva, in laboratori di scrittura e di voce." },
      terr: { fr: "Enraciné en France, soutenu par le CNM ; coproductions en cours de montage.", es: "Enraizado en Francia, apoyado por el CNM; coproducciones en construcción.", en: "Rooted in France, supported by the CNM; coproductions being assembled.", zh: "扎根法国，获 CNM 支持；联合制作筹备中。", it: "Radicato in Francia, sostenuto dal CNM; coproduzioni in fase di costruzione." } },
    "rut": { tx: { fr: "Masterclass sur le geste de direction comme matière sonore et l'électronique en temps réel.", es: "Masterclass sobre el gesto de dirección como materia sonora y la electrónica en tiempo real.", en: "Masterclass on the conducting gesture as sound material and real-time electronics.", zh: "关于指挥手势作为声音素材与实时电子的大师班。", it: "Masterclass sul gesto della direzione come materia sonora e sull'elettronica in tempo reale." },
      terr: { fr: "Créé en résidence, à la croisée du concert et de la performance.", es: "Creado en residencia, en el cruce entre concierto y performance.", en: "Created in residency, at the crossroads of concert and performance.", zh: "驻地创作，处于音乐会与表演的交汇处。", it: "Creato in residenza, all'incrocio tra concerto e performance." } },
    "fame": { tx: { fr: "La médiation d'Olivia Martin fait de ce récital un espace de parole autour du féminin, ouvert à tou·te·s.", es: "La mediación de Olivia Martin convierte el recital en un espacio de palabra en torno a lo femenino, abierto a todos.", en: "Olivia Martin's mediation turns the recital into a space for speech around the feminine, open to all.", zh: "Olivia Martin 的导赏让这场独奏会成为面向所有人、围绕「女性」的发声空间。", it: "La mediazione di Olivia Martin fa di questo recital uno spazio di parola intorno al femminile, aperto a tutti." },
      terr: { fr: "Créé à l'Auditorium — Orchestre National de Lyon, avec le GRAME.", es: "Creado en el Auditorium — Orchestre National de Lyon, con el GRAME.", en: "Created at the Auditorium — Orchestre National de Lyon, with GRAME.", zh: "于里昂大礼堂——国家管弦乐团创作，与 GRAME 合作。", it: "Creato all'Auditorium — Orchestre National de Lyon, con il GRAME." } },
    "snow-on-her-lips": { tx: { fr: "Atelier transdisciplinaire : théâtre musical, danse, vidéo et électronique réunis.", es: "Taller transdisciplinar: teatro musical, danza, vídeo y electrónica reunidos.", en: "Cross-disciplinary workshop: music theatre, dance, video and electronics together.", zh: "跨学科工作坊：音乐剧场、舞蹈、影像与电子的汇聚。", it: "Laboratorio transdisciplinare: teatro musicale, danza, video ed elettronica riuniti." },
      terr: { fr: "Pensé pour le public du Printemps des Arts, sur la Riviera.", es: "Pensado para el público del Printemps des Arts, en la Riviera.", en: "Made for the Printemps des Arts audience, on the Riviera.", zh: "为蒙特卡洛艺术之春的观众而作，位于里维埃拉。", it: "Pensato per il pubblico del Printemps des Arts, sulla Riviera." } },
    "otages": { tx: { fr: "Rencontres autour de l'adaptation littéraire à l'opéra et du travail vocal contemporain.", es: "Encuentros en torno a la adaptación literaria a la ópera y el trabajo vocal contemporáneo.", en: "Encounters around literary adaptation to opera and contemporary vocal work.", zh: "围绕文学改编为歌剧与当代人声创作的相遇。", it: "Incontri sull'adattamento letterario all'opera e sul lavoro vocale contemporaneo." },
      terr: { fr: "Ancré à Lyon, en lien avec les scènes lyriques et les publics de la région.", es: "Anclado en Lyon, en relación con las escenas líricas y los públicos de la región.", en: "Anchored in Lyon, connected to opera stages and regional audiences.", zh: "扎根里昂，与歌剧舞台及地区观众相连。", it: "Radicato a Lione, in dialogo con i teatri d'opera e il pubblico della regione." } },
    "insistir": { tx: { fr: "Transmission du répertoire d'Aperghis et du théâtre musical à de jeunes interprètes.", es: "Transmisión del repertorio de Aperghis y del teatro musical a jóvenes intérpretes.", en: "Passing on Aperghis's repertoire and music theatre to young performers.", zh: "向年轻表演者传授 Aperghis 的作品与音乐剧场。", it: "Trasmissione del repertorio di Aperghis e del teatro musicale a giovani interpreti." },
      terr: { fr: "Porté par STOPERA! autour de la soprano Nicola Beller Carbone.", es: "Impulsado por STOPERA! en torno a la soprano Nicola Beller Carbone.", en: "Carried by STOPERA! around soprano Nicola Beller Carbone.", zh: "由 STOPERA! 围绕女高音 Nicola Beller Carbone 推进。", it: "Portato da STOPERA! intorno al soprano Nicola Beller Carbone." } },
    "mamma-roma": { tx: { fr: "Ateliers sur le geste scénique et l'objet — la table — comme espace dramaturgique.", es: "Talleres sobre el gesto escénico y el objeto —la mesa— como espacio dramatúrgico.", en: "Workshops on stage gesture and the object — the table — as dramaturgical space.", zh: "围绕舞台动作与物件（餐桌）作为戏剧空间的工作坊。", it: "Laboratori sul gesto scenico e sull'oggetto — il tavolo — come spazio drammaturgico." },
      terr: { fr: "Création à Buenos Aires, en dialogue avec la scène lyrique argentine.", es: "Estreno en Buenos Aires, en diálogo con la escena lírica argentina.", en: "Premiering in Buenos Aires, in dialogue with the Argentine opera scene.", zh: "于布宜诺斯艾利斯首演，与阿根廷歌剧场景对话。", it: "Prima a Buenos Aires, in dialogo con la scena lirica argentina." } },
    "america": { tx: { fr: "Échanges autour de l'opéra engagé et de l'histoire anarchiste portée à la scène.", es: "Intercambios en torno a la ópera comprometida y la historia anarquista llevada a escena.", en: "Exchanges around politically engaged opera and anarchist history brought to the stage.", zh: "围绕介入性歌剧与搬上舞台的无政府主义历史的交流。", it: "Scambi sull'opera impegnata e sulla storia anarchica portata in scena." },
      terr: { fr: "Création à Mexico, mise en scène de Marcelo Lombardero.", es: "Estreno en México, dirección de Marcelo Lombardero.", en: "Premiere in Mexico City, staged by Marcelo Lombardero.", zh: "墨西哥城首演，Marcelo Lombardero 执导。", it: "Prima a Città del Messico, regia di Marcelo Lombardero." } },
    "lips": { tx: { fr: "LIPS est lui-même un espace de transmission : prototypage, mentorat et partage entre artistes.", es: "LIPS es en sí mismo un espacio de transmisión: prototipado, mentoría e intercambio entre artistas.", en: "LIPS is itself a space of transmission: prototyping, mentoring and exchange between artists.", zh: "LIPS 本身即是传承的空间：原型创作、师徒指导与艺术家之间的交流。", it: "LIPS è esso stesso uno spazio di trasmissione: prototipazione, mentorato e scambio tra artisti." },
      terr: { fr: "Un réseau de partenaires en France et à l'international, tous les deux ans.", es: "Una red de socios en Francia y en el extranjero, cada dos años.", en: "A network of partners in France and abroad, every two years.", zh: "每两年一届，连接法国与国际的伙伴网络。", it: "Una rete di partner in Francia e all'estero, ogni due anni." } }
  };
  ...
  var PROJECTS = [
    {
      ...
      facts: [
        ...
        { k: { fr: "Compagnie", es: "Compañía", en: "Company", zh: "剧团", it: "Compagnia" }, v: "Cie Trilobite — Renaud Porte" },
      ...
      credits: [
        { role: { fr: "Musique, texte & mise en scène", es: "Música, texto & dirección", en: "Music, text & staging", zh: "音乐、文本与导演", it: "Musica, testo & regia" }, who: "Renaud Porte" },
      ...
      relations: [
        { label: { fr: "Renaud Porte", es: "Renaud Porte", en: "Renaud Porte", zh: "Renaud Porte", it: "Renaud Porte" }, href: "artists/porte-renaud/" },
      ...
      links: [
        ...
        { label: "Renaud Porte — éditions Lacroch'", url: "https://lacroch.com/catalogue/semifuza/porte-renaud/" },
    ...
    },
    {
      ...
      pitch: {
        ...
        zh: "「旧世界已死。」当人类缺席，当下被悬置：自然记忆，物件自我显现，失灵的人工智能无济于事。OOO 也是一部<strong>被幽灵萦绕的歌剧</strong>——一个由技术、自然与大众记忆的残迹所栖居的世界，<strong>Dalida</strong> 的身影作为反复出现的在场回归：她的歌声与幽灵踪迹，将作品的思考与一种集体情感记忆相连。透过一株室内植物与一个无法想象的机器人之间的对话，<strong>OOO</strong> 展开为一连串视听仪式：一部没有人类的歌剧，一场献给「之后世界」的仪式。Emma Terno 与 Valentín Pelisch 构思并导演。", it: "«Il vecchio mondo è morto.» Privato dell'umanità, il presente si sospende: la natura ricorda, gli oggetti si manifestano, un'intelligenza artificiale difettosa non è di alcun aiuto. OOO è anche un'<strong>opera infestata</strong> — un mondo popolato da vestigia della tecnologia, della natura e della memoria popolare, dove la figura di <strong>Dalida</strong> torna come presenza ricorrente: le sue canzoni e la sua traccia spettrale legano il pensiero del progetto a una memoria emotiva collettiva. Attraverso il dialogo di una pianta d'appartamento e di un robot incapace di immaginare, <strong>OOO</strong> dispiega una serie di rituali audiovisivi: un'opera senza umani, un rituale per il mondo di dopo. Ideazione e regia di Emma Terno e Valentín Pelisch." },
      body: [
        { fr: "OOO n'est pas seulement une affaire d'objets, d'intelligence artificielle et de futurs post-humains : c'est aussi une œuvre sur la mémoire, la disparition et ce qui survit. Dalida y revient comme l'un des fantômes qui hantent le plateau — une voix populaire dont les chansons continuent de circuler longtemps après l'effacement de celle qui les portait. À travers elle, l'opéra demande ce qu'il reste d'une présence humaine lorsque les corps ont disparu : des refrains, des images, une émotion partagée — ce que l'imaginaire collectif garde en mémoire quand tout le reste s'efface.",
          ...
          zh: "OOO 并不只关乎物件、人工智能与后人类的未来：它也是一部关于记忆、消失以及何物得以幸存的作品。Dalida 作为萦绕舞台的幽灵之一回归——一个大众的声音，她的歌声在承载它的人被抹去之后，依然久久流传。透过她，这部歌剧追问：当身体消失之后，人的在场还留下什么——副歌、影像、一种共同的情感——当其余一切褪去，集体想象所留存之物。", it: "OOO non riguarda soltanto gli oggetti, l'intelligenza artificiale e i futuri post-umani: è anche un'opera sulla memoria, sulla scomparsa e su ciò che sopravvive. Dalida vi torna come uno dei fantasmi che infestano la scena — una voce popolare le cui canzoni continuano a circolare molto dopo la cancellazione di chi le portava. Attraverso di lei, l'opera chiede che cosa resti di una presenza umana quando i corpi sono scomparsi: ritornelli, immagini, un'emozione condivisa — ciò che l'immaginario collettivo conserva quando tutto il resto si cancella." }
      ],
      facts: [
        { k: { fr: "Genre", es: "Género", en: "Genre", zh: "类型", it: "Genere" }, v: { fr: "Opéra post-humain & hanté", es: "Ópera posthumana & fantasmal", en: "Post-human & haunted opera", zh: "后人类与幽灵歌剧", it: "Opera post-umana & infestata" } },
        { k: { fr: "Présences", es: "Presencias", en: "Presences", zh: "在场", it: "Presenze" }, v: { fr: "Dalida · objets · nature · IA", es: "Dalida · objetos · naturaleza · IA", en: "Dalida · objects · nature · AI", zh: "Dalida · 物件 · 自然 · AI", it: "Dalida · oggetti · natura · IA" } },
        { k: { fr: "Conception & direction", es: "Concepción & dirección", en: "Creation & direction", zh: "构思与导演", it: "Ideazione & regia" }, v: "Emma Terno · Valentín Pelisch" },
        { k: { fr: "Création", es: "Estreno", en: "Premiere", zh: "首演", it: "Prima" }, v: { fr: "CETC — Teatro Colón (Buenos Aires), sept. 2025", es: "CETC — Teatro Colón (Buenos Aires), sept. 2025", en: "CETC — Teatro Colón (Buenos Aires), Sept. 2025", zh: "CETC — 科隆剧院（布宜诺斯艾利斯），2025 年 9 月", it: "CETC — Teatro Colón (Buenos Aires), set. 2025" } },
        { k: { fr: "Production", es: "Producción", en: "Production", zh: "制作", it: "Produzione" }, v: "GRAME — CNCM (Lyon) · CETC — Teatro Colón" },
        { k: { fr: "Diffusion internationale", es: "Difusión internacional", en: "International diffusion", zh: "国际巡演", it: "Distribuzione internazionale" }, v: "STOPERA!" }
      ],
      credits: [
        { role: { fr: "Conception & direction", es: "Concepción & dirección", en: "Creation & direction", zh: "构思与导演", it: "Ideazione & regia" }, who: "Emma Terno · Valentín Pelisch" },
        { role: { fr: "Performeur·ses", es: "Performers", en: "Performers", zh: "表演者", it: "Performer" }, who: "Manuel Atwell · Emma Terno" }
      ],
      tech: [
        { k: { fr: "Saxophone baryton", es: "Saxo barítono", en: "Baritone sax", zh: "上低音萨克斯", it: "Sassofono baritono" }, v: "Carolina Cervetto" },
        { k: { fr: "Alto", es: "Viola", en: "Viola", zh: "中提琴", it: "Viola" }, v: "Mariano Malamud" },
        { k: { fr: "Violoncelle", es: "Violonchelo", en: "Cello", zh: "大提琴", it: "Violoncello" }, v: "Juan Ignacio Ferrera" },
        { k: { fr: "Clarinette basse", es: "Clarinete bajo", en: "Bass clarinet", zh: "低音单簧管", it: "Clarinetto basso" }, v: "Lautaro Abrego" },
        { k: { fr: "Théorbe", es: "Tiorba", en: "Theorbo", zh: "西奥伯琴", it: "Tiorba" }, v: "Laura Fainstein" },
        { k: { fr: "Lumières", es: "Iluminación", en: "Lighting", zh: "灯光", it: "Luci" }, v: "Adrián Grimozzi" },
        { k: { fr: "Assistante technique", es: "Asistente técnica", en: "Technical assistant", zh: "技术助理", it: "Assistente tecnica" }, v: "Magdalena Picco" },
        { k: { fr: "Costumes", es: "Vestuario", en: "Costume design", zh: "服装设计", it: "Costumi" }, v: "Belén Parra · Florencia Fiori" }
      ],
      diffusion: {
        ...
        zh: "OOO 于 2025 年 9 月在科隆剧院实验中心（CETC，布宜诺斯艾利斯）首演，诞生自里昂 GRAME 国家音乐创作中心与 CETC 的合作。STOPERA! 负责其发展与国际巡演。", it: "Presentato in prima al Centro de Experimentación del Teatro Colón (Buenos Aires) nel settembre 2025, OOO nasce da una cooperazione tra il GRAME — Centre National de Création Musicale (Lione) e il CETC. STOPERA! ne porta lo sviluppo e la distribuzione internazionale." },
      partners: ["GRAME — CNCM (Lyon)", "CETC — Teatro Colón (Buenos Aires)", "STOPERA!"],
      press: [
        { quote: { fr: "OOO invoque Dalida, la chanteuse mythique, dans une succession de rituels audiovisuels où les fantômes chantent de vieilles mélodies.", es: "OOO invoca a Dalida, la mítica cantante, en una sucesión de rituales audiovisuales donde los fantasmas cantan viejas melodías.", en: "OOO invokes Dalida, the mythical singer, in a succession of audiovisual rituals where ghosts sing old melodies.", zh: "OOO 召唤传奇歌手 Dalida，化作一连串视听仪式，幽灵在其中吟唱古老旋律。", it: "OOO evoca Dalida, la cantante mitica, in una successione di rituali audiovisivi dove i fantasmi cantano vecchie melodie." }, source: "Página/12 — Inevitables", url: "https://www.pagina12.com.ar/853209-inevitables/" },
        { quote: { fr: "L'opéra qui imagine un monde sans humains stupéfie au Centre d'expérimentation du Teatro Colón.", es: "La ópera que imagina un mundo sin humanos asombra en el Centro de Experimentación del Teatro Colón.", en: "The opera that imagines a world without humans astonishes at the Teatro Colón's experimentation centre.", zh: "这部想象无人世界的歌剧在科隆剧院实验中心令人惊叹。", it: "L'opera che immagina un mondo senza umani stupisce al Centro di sperimentazione del Teatro Colón." }, source: "Infobae", url: "https://www.infobae.com/cultura/2025/09/03/la-opera-que-imagina-un-mundo-sin-humanos-asombra-en-el-centro-de-experimentacion-del-teatro-colon/" },
        { quote: { fr: "Opéra expérimental : le dialogue entre les plantes et l'intelligence artificielle.", es: "Ópera experimental: el diálogo entre las plantas y la inteligencia artificial.", en: "Experimental opera: the dialogue between plants and artificial intelligence.", zh: "实验歌剧：植物与人工智能之间的对话。", it: "Opera sperimentale: il dialogo tra le piante e l'intelligenza artificiale." }, source: "Clarín", url: "https://www.clarin.com/revista-n/opera-experimental-ooo-dialogo-plantas-inteligencia-artificial_0_0h5nTviRXY.html" }
      ],
      links: [
      ...
      relations: [
        { label: { fr: "Emma Terno", es: "Emma Terno", en: "Emma Terno", zh: "Emma Terno", it: "Emma Terno" }, href: "artists/emma-terno/" },
        { label: { fr: "Valentín Pelisch", es: "Valentín Pelisch", en: "Valentín Pelisch", zh: "Valentín Pelisch", it: "Valentín Pelisch" }, href: "artists/valentin-pelisch/" },
        { label: { fr: "GRAME — CNCM", es: "GRAME — CNCM", en: "GRAME — CNCM", zh: "GRAME — CNCM", it: "GRAME — CNCM" }, url: "https://www.grame.fr" },
        { label: { fr: "CETC — Teatro Colón", es: "CETC — Teatro Colón", en: "CETC — Teatro Colón", zh: "CETC — 科隆剧院", it: "CETC — Teatro Colón" }, url: "https://teatrocolon.org.ar" },
        { label: { fr: "Recherche & innovation", es: "Investigación & innovación", en: "Research & innovation", zh: "研究与创新", it: "Ricerca & innovazione" }, href: "index.html#recherche" },
        { label: { fr: "Coopération internationale", es: "Cooperación internacional", en: "International cooperation", zh: "国际合作", it: "Cooperazione internazionale" }, href: "index.html#reseau" }
      ],
      gallery: [
    ...
    },
    {
      ...
      tag: { fr: "Première fin 2026", es: "Estreno fin de 2026", en: "Premiere late 2026", zh: "2026 年底首演", it: "Prima fine 2026" },
      short: { fr: "Performance solo de Rut Schreiner.", es: "Performance solo de Rut Schreiner.", en: "A solo performance by Rut Schreiner.", zh: "Rut Schreiner 的独角表演。", it: "Performance solista di Rut Schreiner." },
      pitch: {
        ...
        zh: "一场为独奏指挥、传感器、空间化声音与互动影像而作的表演——副标题「Conducting the Invisible」。Rut Schreiner 的指挥手势经实时捕捉，生成、调制并雕塑声音：身体成为乐器，指挥成为音乐素材。", it: "Performance per direttrice sola, sensori, suono spazializzato e video interattivo — sottotitolata «Conducting the Invisible». Il gesto della direzione di Rut Schreiner, catturato in tempo reale, genera, modula e scolpisce il suono: il corpo diventa strumento, la direzione d'orchestra, materia musicale." },
      facts: [
        { k: { fr: "Genre", es: "Género", en: "Genre", zh: "类型", it: "Genere" }, v: { fr: "Performance", es: "Performance", en: "Performance", zh: "表演", it: "Performance" } },
        { k: { fr: "Dispositif", es: "Dispositivo", en: "Set-up", zh: "装置", it: "Dispositivo" }, v: { fr: "Capteurs · son spatialisé · vidéo", es: "Sensores · sonido espacial · vídeo", en: "Sensors · spatial sound · video", zh: "传感器 · 空间声 · 影像", it: "Sensori · suono spazializzato · video" } },
        { k: { fr: "Programme", es: "Programa", en: "Programme", zh: "曲目", it: "Programma" }, v: "Fernández · De Mey · Martínez Álvarez · Alsina Tarrès" },
        { k: { fr: "Première", es: "Estreno", en: "Premiere", zh: "首演", it: "Prima" }, v: { fr: "Fin 2026", es: "Fin de 2026", en: "Late 2026", zh: "2026 年底", it: "Fine 2026" } }
      ],
      credits: [
        { role: { fr: "Conception & interprétation", es: "Concepción & interpretación", en: "Concept & performance", zh: "构思与表演", it: "Ideazione & interpretazione" }, who: "Rut Schreiner" }
      ],
      partners: [],
      note: { fr: "Création en résidence. Dispositif technique en cours de définition.", es: "Creación en residencia. Dispositivo técnico en definición.", en: "Created in residency. Technical set-up being defined.", zh: "驻地创作。技术装置确定中。", it: "Creazione in residenza. Dispositivo tecnico in via di definizione." }
    },
    {
      slug: "fame", title: "[FAM]E", titleHtml: "[FAM]E",
      img: "assets/projects/fame.svg", photo: "assets/projects/fame.jpg",
      tag: { fr: "Auditorium de Lyon · 2021", es: "Auditorium de Lyon · 2021", en: "Auditorium de Lyon · 2021", zh: "里昂大礼堂 · 2021", it: "Auditorium de Lyon · 2021" },
      short: { fr: "Récital de percussions d'Olivia Martin, autour du féminin.", es: "Recital de percusión de Olivia Martin, en torno a lo femenino.", en: "A percussion recital by Olivia Martin, around the feminine.", zh: "Olivia Martin 的打击乐独奏会，围绕「女性」。", it: "Recital di percussioni di Olivia Martin, intorno al femminile." },
      pitch: {
        ...
        zh: "<em>Pop-Up Exploratoire #1</em>，与 GRAME 共同构想：一场打击乐独奏会，Olivia Martin 借由当代创作，细腻地编织出一条关于「女性」的线索——女性的声音、位置与在场。在 Guillaume Kosmicki 的导赏下，这场「面向所有人」的节目既是音乐会，也是一种让某种声音被听见的方式。于里昂大礼堂——国家管弦乐团（Salle Proton）首演。", it: "<em>Pop-Up Exploratoire #1</em> ideato con il GRAME: un recital in cui la percussionista Olivia Martin compone, attraverso la creazione contemporanea, un percorso sensibile intorno al femminile — la voce delle donne, il loro posto, la loro presenza. Sostenuto dalla mediazione di Guillaume Kosmicki, questo programma «per tutti» è tanto un concerto quanto un modo di far ascoltare una parola. Creato all'Auditorium — Orchestre National de Lyon (Salle Proton)." },
      facts: [
        { k: { fr: "Genre", es: "Género", en: "Genre", zh: "类型", it: "Genere" }, v: { fr: "Pop-Up Exploratoire · percussion solo", es: "Pop-Up Exploratoire · percusión solo", en: "Pop-Up Exploratoire · solo percussion", zh: "Pop-Up Exploratoire · 打击乐独奏", it: "Pop-Up Exploratoire · percussioni solo" } },
        { k: { fr: "Autour de", es: "En torno a", en: "Around", zh: "主题", it: "Intorno a" }, v: { fr: "Le féminin", es: "Lo femenino", en: "The feminine", zh: "女性", it: "Il femminile" } },
        { k: { fr: "Interprète", es: "Intérprete", en: "Performer", zh: "演奏", it: "Interprete" }, v: "Olivia Martin" },
        { k: { fr: "Présentation", es: "Presentación", en: "Hosted by", zh: "讲解", it: "Presentazione" }, v: "Guillaume Kosmicki" },
        { k: { fr: "Programme", es: "Programa", en: "Programme", zh: "曲目", it: "Programma" }, v: { fr: "Rebotier · Aperghis · Volans · Rudel Rey · Caget · Taïra", es: "Rebotier · Aperghis · Volans · Rudel Rey · Caget · Taïra", en: "Rebotier · Aperghis · Volans · Rudel Rey · Caget · Taïra", zh: "Rebotier · Aperghis · Volans · Rudel Rey · Caget · Taïra", it: "Rebotier · Aperghis · Volans · Rudel Rey · Caget · Taïra" } },
        { k: { fr: "Création", es: "Estreno", en: "Premiere", zh: "首演", it: "Prima" }, v: { fr: "Auditorium — ONL (Salle Proton), 2021", es: "Auditorium — ONL (Salle Proton), 2021", en: "Auditorium — ONL (Salle Proton), 2021", zh: "里昂大礼堂 — ONL（Salle Proton），2021", it: "Auditorium — ONL (Salle Proton), 2021" } }
      ],
      credits: [
        { role: { fr: "Percussions", es: "Percusión", en: "Percussion", zh: "打击乐", it: "Percussioni" }, who: "Olivia Martin" },
        { role: { fr: "Présentation & médiation", es: "Presentación & mediación", en: "Presentation & mediation", zh: "讲解与导赏", it: "Presentazione & mediazione" }, who: "Guillaume Kosmicki" }
      ],
      partners: [],
      links: [
    ...
    },
    {
      ...
      tag: { fr: "Monte-Carlo · 2021", es: "Monte-Carlo · 2021", en: "Monte-Carlo · 2021", zh: "蒙特卡洛 · 2021", it: "Monte-Carlo · 2021" },
      short: { fr: "Monodrame : théâtre musical, danse, vidéo & électronique.", es: "Monodrama: teatro musical, danza, vídeo y electrónica.", en: "A monodrama: music theatre, dance, video & electronics.", zh: "独角戏：音乐剧场、舞蹈、影像与电子。", it: "Monodramma: teatro musicale, danza, video & elettronica." },
      pitch: {
        ...
        zh: "一部沉浸式独角戏，为一位表演者、两位乐手、物件、电子与影像而作。灵感取自汉斯·贝尔默与海纳·穆勒的文本（<em>哈姆雷特机器</em>），追随一位女性自我瓦解、解放与焚毁的独白——直到这种毁灭成为重建的可能序曲。受蒙特卡洛艺术之春委约。", it: "Monodramma immersivo per una performer, due strumentisti, oggetti, elettronica e video. Ispirato a Hans Bellmer e a testi di Heiner Müller (<em>Hamlet-Machine</em>), segue il monologo di una donna che si disfa, si libera e si consuma — fino a fare di questa distruzione il possibile preludio di una ricostruzione. Commissione del Printemps des Arts de Monte-Carlo." },
      facts: [
        { k: { fr: "Genre", es: "Género", en: "Genre", zh: "类型", it: "Genere" }, v: { fr: "Monodrame / théâtre musical", es: "Monodrama / teatro musical", en: "Monodrama / music theatre", zh: "独角戏 / 音乐剧场", it: "Monodramma / teatro musicale" } },
        { k: { fr: "D'après", es: "A partir de", en: "After", zh: "取材自", it: "Da" }, v: { fr: "Hans Bellmer · Heiner Müller", es: "Hans Bellmer · Heiner Müller", en: "Hans Bellmer · Heiner Müller", zh: "汉斯·贝尔默 · 海纳·穆勒", it: "Hans Bellmer · Heiner Müller" } },
        { k: { fr: "Durée", es: "Duración", en: "Duration", zh: "时长", it: "Durata" }, v: "55 min" },
        { k: { fr: "Création", es: "Estreno", en: "Premiere", zh: "首演", it: "Prima" }, v: { fr: "Printemps des Arts de Monte-Carlo, 2021", es: "Printemps des Arts de Monte-Carlo, 2021", en: "Printemps des Arts de Monte-Carlo, 2021", zh: "蒙特卡洛艺术之春，2021", it: "Printemps des Arts de Monte-Carlo, 2021" } }
      ],
      credits: [
        { role: { fr: "Composition & mise en scène", es: "Composición & dirección", en: "Composition & staging", zh: "作曲与导演", it: "Composizione & regia" }, who: "Sebastian Rivas" },
        { role: { fr: "Performeuse", es: "Performer", en: "Performer", zh: "表演者", it: "Performer" }, who: "Emma Terno" },
        { role: { fr: "Vidéo & informatique musicale", es: "Vídeo & informática musical", en: "Video & music computing", zh: "影像与音乐信息", it: "Video & informatica musicale" }, who: "Daniel Zea" },
        { role: { fr: "Ensemble", es: "Ensemble", en: "Ensemble", zh: "乐团", it: "Ensemble" }, who: "Êkheía — Bastien Roblot, Olivia Martin" },
        { role: { fr: "Lumières & scénographie", es: "Luces & escenografía", en: "Lighting & set design", zh: "灯光与舞美", it: "Luci & scenografia" }, who: "Jean-Cyrille Burdet" },
        { role: { fr: "Regard extérieur", es: "Mirada externa", en: "Outside eye", zh: "外部视角", it: "Sguardo esterno" }, who: "Géraldine Kosiak" }
      ],
    ...
    },
    {
      ...
      short: { fr: "Opéra d'après Nina Bouraoui — Opéra de Lyon.", es: "Ópera a partir de Nina Bouraoui — Opéra de Lyon.", en: "An opera after Nina Bouraoui — Opéra de Lyon.", zh: "改编自 Nina Bouraoui 的歌剧 —— 里昂歌剧院。", it: "Opera da Nina Bouraoui — Opéra de Lyon." },
      pitch: {
        ...
        zh: "一部根据 Nina Bouraoui 文本创作的三幕歌剧。Sylvie Meyer 的肖像——一个「平凡而非凡」的女人，五十三年来顺从他人的期待，直到那个颠覆一切、既应受谴责又带来解放的举动：「我是 Sylvie Meyer」。Richard Brunel 执导。", it: "Opera in tre atti dal testo di Nina Bouraoui. Il ritratto di Sylvie Meyer, donna «ordinaria e straordinaria» che si conforma per cinquantatré anni a ciò che ci si aspetta da lei — fino al gesto che fa vacillare tutto, riprovevole e liberatorio: «io sono Sylvie Meyer». Regia di Richard Brunel." },
      facts: [
        { k: { fr: "Genre", es: "Género", en: "Genre", zh: "类型", it: "Genere" }, v: { fr: "Opéra (3 actes)", es: "Ópera (3 actos)", en: "Opera (3 acts)", zh: "歌剧（三幕）", it: "Opera (3 atti)" } },
        { k: { fr: "Texte", es: "Texto", en: "Text", zh: "文本", it: "Testo" }, v: "Nina Bouraoui" },
        { k: { fr: "Mise en scène", es: "Dirección", en: "Stage direction", zh: "导演", it: "Regia" }, v: "Richard Brunel" },
        { k: { fr: "Direction musicale", es: "Dirección musical", en: "Conducting", zh: "音乐指挥", it: "Direzione musicale" }, v: "Rut Schreiner" },
        { k: { fr: "Création", es: "Estreno", en: "Premiere", zh: "首演", it: "Prima" }, v: { fr: "Opéra de Lyon · Croix-Rousse, mars 2024", es: "Opéra de Lyon · Croix-Rousse, marzo 2024", en: "Opéra de Lyon · Croix-Rousse, March 2024", zh: "里昂歌剧院 · Croix-Rousse，2024 年 3 月", it: "Opéra de Lyon · Croix-Rousse, marzo 2024" } }
      ],
      credits: [
        { role: { fr: "Musique", es: "Música", en: "Music", zh: "音乐", it: "Musica" }, who: "Sebastian Rivas" },
        { role: { fr: "Texte", es: "Texto", en: "Text", zh: "文本", it: "Testo" }, who: "Nina Bouraoui" },
        { role: { fr: "Mise en scène", es: "Dirección de escena", en: "Stage direction", zh: "导演", it: "Regia" }, who: "Richard Brunel" },
        { role: { fr: "Direction musicale", es: "Dirección musical", en: "Conducting", zh: "音乐指挥", it: "Direzione musicale" }, who: "Rut Schreiner" },
        { role: { fr: "Avec", es: "Con", en: "With", zh: "演员", it: "Con" }, who: "Nicola Beller Carbone · Yvan Ludlow" }
      ],
      partners: ["Opéra de Lyon", "GRAME", "Théâtre de la Croix-Rousse"],
      financeurs: ["Fondation Jerez (sous l'égide de la Fondation de France)"],
      press: [
        { quote: { fr: "Une femme de 53 ans s'y livre au commentaire très rationnel de l'acte de violence qui l'a libérée de tout ce qu'elle a subi jusque-là.", es: "Una mujer de 53 años se entrega al comentario muy racional del acto de violencia que la liberó de todo lo que había sufrido.", en: "A 53-year-old woman delivers a coolly rational commentary on the act of violence that freed her from all she had endured.", zh: "一位 53 岁的女性，冷静而理性地讲述那个将她从此前所受的一切中解放出来的暴力行为。", it: "Una donna di 53 anni si abbandona al commento lucidissimo dell'atto di violenza che l'ha liberata da tutto ciò che aveva subito fino ad allora." }, source: "Le Monde", url: "https://www.lemonde.fr/culture/article/2024/03/19/otages-un-opera-qui-libere-la-parole-feminine-mais-pas-le-chant_6222903_3246.html" },
        { quote: { fr: "Le compositeur franco-argentin donne à entendre la violence sociale et sexiste.", es: "El compositor franco-argentino hace oír la violencia social y sexista.", en: "The French-Argentine composer makes social and sexist violence audible.", zh: "这位法国-阿根廷作曲家让社会与性别暴力被听见。", it: "Il compositore franco-argentino dà voce alla violenza sociale e sessista." }, source: "Diapason", url: "https://www.diapasonmag.fr/critiques/otages-de-sebastian-rivas-a-lyon-un-drame-feministe-en-musique-46011.html" },
        { quote: { fr: "Sylvie Meyer découvre qu'elle est doublement otage : amoureuse et économique.", es: "Sylvie Meyer descubre que es doblemente rehén: amorosa y económica.", en: "Sylvie Meyer discovers she is a hostage twice over: emotionally and economically.", zh: "Sylvie Meyer 发现自己是双重人质：情感的与经济的。", it: "Sylvie Meyer scopre di essere ostaggio due volte: in amore e nell'economia." }, source: "ResMusica", url: "https://www.resmusica.com/2024/03/20/otages-a-lyon-la-fin-de-la-soumission/" },
        { quote: { fr: "Le livret s'avère d'une grande richesse, en prise avec notre époque.", es: "El libreto resulta de gran riqueza, en sintonía con nuestra época.", en: "The libretto proves richly resonant, in touch with our time.", zh: "剧本极为丰富，紧扣我们的时代。", it: "Il libretto si rivela di grande ricchezza, in presa diretta con la nostra epoca." }, source: "Forum Opéra", url: "https://www.forumopera.com/spectacle/rivas-otages-lyon/" },
        { quote: { fr: "Entre musique et théâtre, le mariage est réussi.", es: "Entre música y teatro, la unión es lograda.", en: "Between music and theatre, the marriage is a success.", zh: "音乐与戏剧的结合十分成功。", it: "Tra musica e teatro, il matrimonio è riuscito." }, source: "Classykéo", url: "https://www.classykeo.com/2024/03/29/otages-faites-entrer-laccuse/" }
      ],
      pressPdf: "assets/press/otages-revue-presse.pdf",
      note: { fr: "Création mondiale le 17 mars 2024 (Festival de l'Opéra de Lyon).", es: "Estreno mundial el 17 de marzo de 2024 (Festival de la Opéra de Lyon).", en: "World premiere on 17 March 2024 (Opéra de Lyon Festival).", zh: "2024 年 3 月 17 日世界首演（里昂歌剧院艺术节）。", it: "Prima mondiale il 17 marzo 2024 (Festival de l'Opéra de Lyon)." }
    },
    {
      slug: "insistir", title: "Insistir", titleHtml: "Insistir",
      photo: "assets/projects/insistir.jpg",
      tag: { fr: "Création 2026 · Mexico", es: "Estreno 2026 · México", en: "Premiere 2026 · Mexico City", zh: "2026 首演 · 墨西哥城", it: "Prima 2026 · Città del Messico" },
      short: { fr: "Performance pour Nicola Beller Carbone, autour de pièces de Georges Aperghis.", es: "Performance para Nicola Beller Carbone, en torno a piezas de Georges Aperghis.", en: "A performance for Nicola Beller Carbone, around works by Georges Aperghis.", zh: "为 Nicola Beller Carbone 而作的表演，围绕 Georges Aperghis 的作品。", it: "Performance per Nicola Beller Carbone, intorno a pezzi di Georges Aperghis." },
      pitch: {
        ...
        zh: "一部为独奏表演者而作的舞台表演，由 Nicola Beller Carbone 演绎，围绕 Georges Aperghis 的作品构建。它与一个奠基性姿态对话——1993 年 Susan Sontag 在被围困的萨拉热窝执导《<em>等待戈多</em>》——追问极端处境中的在场：人声作为材料，重复作为行动，坚持作为抵抗。预计 2026 年于墨西哥城首演。", it: "Performance scenica per un'interprete sola in scena, portata da Nicola Beller Carbone e costruita intorno a pezzi di Georges Aperghis. In dialogo con un gesto fondatore — la regia di <em>Aspettando Godot</em> di Susan Sontag nella Sarajevo assediata (1993) —, interroga la presenza in situazione estrema: la voce come materia, la ripetizione come atto, l'insistenza come resistenza. Prima prevista a Città del Messico nel 2026." },
      facts: [
        { k: { fr: "Genre", es: "Género", en: "Genre", zh: "类型", it: "Genere" }, v: { fr: "Performance", es: "Performance", en: "Performance", zh: "表演", it: "Performance" } },
        { k: { fr: "Œuvres", es: "Obras", en: "Works", zh: "作品", it: "Opere" }, v: "Georges Aperghis" },
        { k: { fr: "Interprète", es: "Intérprete", en: "Performer", zh: "表演者", it: "Interprete" }, v: "Nicola Beller Carbone" },
        { k: { fr: "Direction artistique", es: "Dirección artística", en: "Artistic direction", zh: "艺术指导", it: "Direzione artistica" }, v: "Nicola Beller Carbone · Martin Bauer" },
        { k: { fr: "Création", es: "Estreno", en: "Premiere", zh: "首演", it: "Prima" }, v: { fr: "Mexico, 2026", es: "México, 2026", en: "Mexico City, 2026", zh: "墨西哥城，2026", it: "Città del Messico, 2026" } }
      ],
      credits: [
        { role: { fr: "Direction artistique", es: "Dirección artística", en: "Artistic direction", zh: "艺术指导", it: "Direzione artistica" }, who: "Nicola Beller Carbone · Martin Bauer" },
        { role: { fr: "Interprète", es: "Intérprete", en: "Performer", zh: "表演者", it: "Interprete" }, who: "Nicola Beller Carbone" },
        { role: { fr: "Œuvres", es: "Obras", en: "Works", zh: "作品", it: "Opere" }, who: "Georges Aperghis" }
      ],
      partners: [],
    ...
    },
    {
      ...
      short: { fr: "Opéra : América Scarfó & Soledad Rosas, l'amour comme acte révolutionnaire.", es: "Ópera: América Scarfó y Soledad Rosas, el amor como acto revolucionario.", en: "An opera: América Scarfó & Soledad Rosas, love as a revolutionary act.", zh: "歌剧：América Scarfó 与 Soledad Rosas，爱作为革命行动。", it: "Opera: América Scarfó & Soledad Rosas, l'amore come atto rivoluzionario." },
      pitch: {
        ...
        zh: "一部歌剧，交织 <em>América Scarfó</em> 与 <em>Soledad Rosas</em> 两位女性的命运——她们因爱、流亡与抗争而相连：1930 年代的无政府主义（阿根廷、欧洲）与 1990 年代意大利的占屋运动。如同贝尔格的《<em>璐璐</em>》，作品探问爱的力量；但在这里，爱成为革命行动，是面对压迫体制的自主宣言。Sebastian Rivas 作曲，Marcelo Lombardero 戏剧构作与导演。", it: "Opera che intreccia i destini di <em>América Scarfó</em> e di <em>Soledad Rosas</em>, due donne legate dall'amore, dall'esilio e dalla lotta — l'anarchismo degli anni Trenta (Argentina, Europa) e i movimenti di occupazione dell'Italia degli anni Novanta. Come la <em>Lulu</em> di Berg, l'opera sonda il potere dell'amore; ma qui l'amore diventa un atto rivoluzionario, affermazione di autonomia di fronte ai sistemi oppressivi. Musica di Sebastian Rivas, drammaturgia e regia di Marcelo Lombardero." },
      facts: [
        { k: { fr: "Genre", es: "Género", en: "Genre", zh: "类型", it: "Genere" }, v: { fr: "Opéra", es: "Ópera", en: "Opera", zh: "歌剧", it: "Opera" } },
        { k: { fr: "Figures", es: "Figuras", en: "Figures", zh: "人物", it: "Figure" }, v: "América Scarfó · Soledad Rosas" },
        { k: { fr: "Dramaturgie & mise en scène", es: "Dramaturgia & dirección", en: "Dramaturgy & staging", zh: "戏剧构作与导演", it: "Drammaturgia & regia" }, v: "Marcelo Lombardero" },
        { k: { fr: "Création", es: "Creación", en: "Creation", zh: "创作", it: "Prima" }, v: { fr: "Mexico — date à venir", es: "México — fecha por confirmar", en: "Mexico City — date TBC", zh: "墨西哥城 — 日期待定", it: "Città del Messico — data da definire" } }
      ],
      credits: [
        { role: { fr: "Musique", es: "Música", en: "Music", zh: "音乐", it: "Musica" }, who: "Sebastian Rivas" },
        { role: { fr: "Dramaturgie & mise en scène", es: "Dramaturgia & dirección", en: "Dramaturgy & staging", zh: "戏剧构作与导演", it: "Drammaturgia & regia" }, who: "Marcelo Lombardero" },
        { role: { fr: "Distribution", es: "Reparto", en: "Cast", zh: "演员", it: "Cast" }, who: { fr: "Scarfó (soprano), Rosas (mezzo), Di Giovanni & Massari (barytons), chœur", es: "Scarfó (soprano), Rosas (mezzo), Di Giovanni y Massari (barítonos), coro", en: "Scarfó (soprano), Rosas (mezzo), Di Giovanni & Massari (baritones), chorus", zh: "Scarfó（女高音）、Rosas（次女高音）、Di Giovanni 与 Massari（男中音）、合唱", it: "Scarfó (soprano), Rosas (mezzo), Di Giovanni & Massari (baritoni), coro" } }
      ],
      partners: [],
      note: { fr: "Sous-titre : Cineres Amoris et Rebellionis. D'après Martín Caparrós (Amor y Anarquía) et Osvaldo Bayer. Création à Mexico — date à venir.", es: "Subtítulo: Cineres Amoris et Rebellionis. A partir de Martín Caparrós (Amor y Anarquía) y Osvaldo Bayer. Estreno en México — fecha por confirmar.", en: "Subtitle: Cineres Amoris et Rebellionis. After Martín Caparrós (Amor y Anarquía) and Osvaldo Bayer. Premiere in Mexico City — date to be confirmed.", zh: "副标题：Cineres Amoris et Rebellionis。取材自 Martín Caparrós（《爱与无政府》）与 Osvaldo Bayer。于墨西哥城首演 —— 日期待定。", it: "Sottotitolo: Cineres Amoris et Rebellionis. Da Martín Caparrós (Amor y Anarquía) e Osvaldo Bayer. Prima a Città del Messico — data da definire." }
    },
    {
      slug: "lips", title: "LIPS Lab", titleHtml: "LIPS Lab",
      img: "assets/projects/lips.svg", photo: "assets/projects/lips.jpg",
      tag: { fr: "Laboratoire international", es: "Laboratorio internacional", en: "International lab", zh: "国际工作坊", it: "Laboratorio internazionale" },
      short: { fr: "Laboratoire de prototypes scéniques & sonores.", es: "Laboratorio de prototipos escénicos & sonoros.", en: "A laboratory of scenic & sound prototypes.", zh: "舞台与声音原型工作坊。", it: "Laboratorio di prototipi scenici & sonori." },
      pitch: {
        ...
        zh: "一个跨学科的舞台与声音原型工作坊。每年，来自各学科——作曲、导演、视觉艺术、戏剧、舞蹈——的青年艺术家在资深艺术家的陪伴下共同打造新形式的雏形。一个交流、实验与共同书写的空间，让传承通过实践发生。", it: "Laboratorio interdisciplinare di prototipi scenici e sonori. Ogni anno, giovani artisti di tutte le discipline — composizione, regia, arti visive, teatro, danza — prototipano insieme nuove forme, accompagnati da artisti affermati. Uno spazio di scambio, sperimentazione e co-scrittura, dove la trasmissione avviene attraverso la pratica." },
      body: [
        { fr: "Le laboratoire procède par protocoles. Chaque édition part d'une question de forme — la voix et le geste captés en temps réel, l'image générée, le son spatialisé, la lutherie d'objets, les écritures écologiques — et la travaille en atelier, en résidence et en répétition, jusqu'au prototype. La transmission s'y fait par la pratique : de jeunes artistes de toutes disciplines prototypent aux côtés d'artistes confirmés.",
          ...
          zh: "实验室以方法推进。每一届都从一个关于形式的问题出发——实时捕捉的人声与动作、生成的图像、空间化的声音、物件乐器、生态书写——并在工作坊、驻地与排练中加以打磨，直至原型。传承通过实践发生：各学科的青年艺术家与资深艺术家一同制作原型。", it: "Il laboratorio procede per protocolli. Ogni edizione parte da una questione di forma — la voce e il gesto catturati in tempo reale, l'immagine generata, il suono spazializzato, la liuteria di oggetti, le scritture ecologiche — e la lavora in laboratorio, in residenza e in prova, fino al prototipo. La trasmissione vi avviene attraverso la pratica: giovani artisti di tutte le discipline prototipano accanto ad artisti affermati." },
        { fr: "Les résultats ne sont pas seulement des spectacles : ce sont des méthodes, des dispositifs et des connaissances documentés, appelés à circuler — publications, ressources ouvertes, collaborations avec des universités et des centres de recherche.",
          ...
          zh: "成果不仅是演出，更是被记录、意在流通的方法、装置与知识——出版、开放资源，以及与高校和研究中心的合作。", it: "I risultati non sono soltanto spettacoli: sono metodi, dispositivi e conoscenze documentate, destinati a circolare — pubblicazioni, risorse aperte, collaborazioni con università e centri di ricerca." }
      ],
      facts: [
        { k: { fr: "Genre", es: "Género", en: "Genre", zh: "类型", it: "Genere" }, v: { fr: "Laboratoire / transmission", es: "Laboratorio / transmisión", en: "Lab / transmission", zh: "工作坊 / 传承", it: "Laboratorio / trasmissione" } },
        { k: { fr: "Démarche", es: "Enfoque", en: "Approach", zh: "方法", it: "Approccio" }, v: { fr: "Co-écriture · interdisciplinarité · intermédialité", es: "Co-escritura · interdisciplinariedad · intermedialidad", en: "Co-writing · interdisciplinarity · intermediality", zh: "共同书写 · 跨学科 · 跨媒介", it: "Co-scrittura · interdisciplinarità · intermedialità" } },
        { k: { fr: "Rythme", es: "Ritmo", en: "Frequency", zh: "频率", it: "Cadenza" }, v: { fr: "Biennal — prochaine édition 2028", es: "Bienal — próxima edición 2028", en: "Biennial — next edition 2028", zh: "双年制 — 下一届 2028", it: "Biennale — prossima edizione 2028" } },
        { k: { fr: "Axes de recherche", es: "Ejes de investigación", en: "Research axes", zh: "研究方向", it: "Assi di ricerca" }, v: { fr: "Temps réel · IA & image générée · spatialisation · voix & dramaturgies · lutherie d'objets · écritures écologiques", es: "Tiempo real · IA & imagen generada · espacialización · voz & dramaturgias · lutería de objetos · escrituras ecológicas", en: "Real time · AI & generated image · spatialisation · voice & dramaturgies · object-instruments · ecological writing", zh: "实时 · AI 与生成图像 · 空间化 · 人声与戏剧构作 · 物件乐器 · 生态书写", it: "Tempo reale · IA & immagine generata · spazializzazione · voce & drammaturgie · liuteria di oggetti · scritture ecologiche" } },
        { k: { fr: "Éditions précédentes", es: "Ediciones anteriores", en: "Previous editions", zh: "往届", it: "Edizioni precedenti" }, v: "Pôle Pixel (Villeurbanne) · GRAME (Lyon) · UNSAM (Buenos Aires)" }
      ],
      pitchExtra: true,
      credits: [
        { role: { fr: "Direction", es: "Dirección", en: "Direction", zh: "负责人", it: "Direzione" }, who: "Sebastian Rivas" },
        { role: { fr: "Informatique musicale", es: "Informática musical", en: "Music computing", zh: "音乐信息", it: "Informatica musicale" }, who: "Max Bruckert" }
      ],
  ...
  function pathLang(pathname) {
    var m = pathname.match(/^\/(es|en|it|zh)(\/|$)/);
    return m ? m[1] : "fr";
  }
  function pathForLang(pathname, lang) {
    var bare = pathname.replace(/^\/(es|en|it|zh)(?=\/|$)/, "");
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var SHARE_DONE = { fr: "Lien copié ✓", es: "Enlace copiado ✓", en: "Link copied ✓", zh: "链接已复制 ✓", it: "Link copiato ✓" };
...
document.addEventListener("DOMContentLoaded", function () {
  document.querySelectorAll("form[data-newsletter]").forEach(function (f) {
    f.addEventListener("submit", function (e) {
      ...
      window.location.href = "mailto:info@stopera.art?subject=" + subj + "&body=" + body;
    });
  });
});
